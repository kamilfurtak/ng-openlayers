...
* **cluster:** add cluster component and demo ([34a1688](https://github.com/kamilfurtak/ng-ol/commit/34a16887e74dbb626d57264d7a086a89f720e61e))
* **cluster:** add wrapX option ([93429a6](https://github.com/kamilfurtak/ng-ol/commit/93429a62afb66718fa1d8ff72700253ae9cfbc1f))
* **cluster:** update distance input ([5edbd57](https://github.com/kamilfurtak/ng-ol/commit/5edbd573f0ef47f156c5ecd4a9fecafeabda19ba))
* **demo:** add example of a cursor position ([9a8988e](https://github.com/kamilfurtak/ng-ol/commit/9a8988e9c29ce00a1e784089dc2ef7d791ff54ea))
* **demo:** add example of geojson feature : point, polygon, linestring ([367c72d](https://github.com/kamilfurtak/ng-ol/commit/367c72de7ef88e3770bb7dbb9e804a70a7eef42e))
* **demo:** add example of map position with longitude, latitude and zoom ([251bbf7](https://github.com/kamilfurtak/ng-ol/commit/251bbf75f6b28e808b3e158edccbe2ffa0c256ac))
* **demo:** add example to display geometry of a geojson file ([fe977e6](https://github.com/kamilfurtak/ng-ol/commit/fe977e6a4733cfa36179eacc0a60297bad7a5113))
* **demo:** example change color on hover or on select ([2e7bda4](https://github.com/kamilfurtak/ng-ol/commit/2e7bda4c2c68810a1f1cd717a20bad4524ee2717))
* **demo:** example draw a polygon ([2737e6b](https://github.com/kamilfurtak/ng-ol/commit/2737e6b114f596456622635933fdeb3955d13d83))
* **demo:** example modify polygon ([18c95fa](https://github.com/kamilfurtak/ng-ol/commit/18c95fa2e2a2a2064347086729cad00c8ea9c730))
* **demo:** example of marker with svg ([b5f57b3](https://github.com/kamilfurtak/ng-ol/commit/b5f57b31770bef156a908df5324a80d2f45a4101))
* **demo:** example of overlay ([b7749f9](https://github.com/kamilfurtak/ng-ol/commit/b7749f9f6bb79403fdcf0f9c4fad225bf6ac5dcf))
...
* **scaleline:** add input units to scaleline component ([26a9a5c](https://github.com/kamilfurtak/ngx-ol/commit/26a9a5c222c862a2c7a313eceffb3aa05b14bb50))
